  ...
  <div id="ChinaWord">
    ...
    <el-row>
      <el-col :span="8" class="explain-out">
        <div class="grid-content bg-purple chengyu-explain">{{cpu_explain}}</div>
      </el-col>
      <el-col :span="8">
        <div class="grid-content chengyu_list_box">
          <div v-for="(word,index) in words" :key="index" id="chengyu_list">
            <div v-if="index%2==0">
              <div class="player_chengyu_box">
                <div class="player_chengyu">{{word}}</div>
              </div>
            </div>
            <div v-else>
              <div class="cpu_chengyu_box">
                <p class="cpu_chengyu">{{word}}</p>
              </div>
            </div>
          </div>
        </div>
